...
import com.yangbingdong.redisoperv2.core.metadata.index.EntityIndex;
import com.yangbingdong.redisoperv2.core.metadata.index.EntityIndexEntry;
import com.yangbingdong.redisoperv2.core.metadata.index.EntitySingleIndex;
import com.yangbingdong.redisoperv2.core.metadata.index.EntityUnionIndex;
...
public abstract class AbstractBeanPostProcessor implements BeanPostProcessor, ApplicationContextAware {
	...
	private void injectRedisoper(RedisoperAware bean, Class entityClass) {
		...
		Redisoper genericRedisoper = new Redisoper<>(metadata);
